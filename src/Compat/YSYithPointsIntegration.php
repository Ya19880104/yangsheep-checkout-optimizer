        ...
        wp_localize_script(
            ...
            array(
                ...
                'i18n'            => array(
                    ...
                    'conversion_prefix' => __( '目前輸入', 'yangsheep-checkout-optimization' ),
                    'conversion_discount' => __( '可折抵', 'yangsheep-checkout-optimization' ),
                    'conversion_calculating' => __( '正在換算折抵金額…', 'yangsheep-checkout-optimization' ),
                    'conversion_invalid' => __( '請輸入有效點數以查看折抵金額。', 'yangsheep-checkout-optimization' ),
                    'conversion_unavailable' => __( '折抵金額將於套用時由 YITH 確認。', 'yangsheep-checkout-optimization' ),
